...
def _load_btc_iron_fly():
    return build_btc_iron_fly_recommendation()
...
try:
    result = _load_btc_iron_fly()
except Exception as exc:
    st.error(f"BTC Iron Fly calculation unavailable: {exc}")
    st.stop()
...
with tab_legs:
    ...
    if legs:
        ...
        st.warning("No valid BTC Iron Fly structure selected.")
    st.dataframe(
