...
class DurableGridBotLifecycle:
    ...
    def _build_stop_summary(self, run: dict, reason: str, reconciliation: dict, position: Decimal, open_orders: list[dict]) -> dict:
        ...
        return {
            ...
            "cycles_total": accounting.grid_cycles_completed,
            "completed_grid_cycles": accounting.grid_cycles_completed,
            "fifo_inventory_closures_total": accounting.fifo_inventory_closures_completed,
