...
MARKET_REFRESH_INTERVAL_SECONDS = get_int_config("MARKET_REFRESH_INTERVAL_SECONDS", 300)
PAPER_TRADING_INTERVAL_SECONDS = get_int_config("PAPER_TRADING_INTERVAL_SECONDS", 300)
FUTURES_TRADING_INTERVAL_SECONDS = get_int_config("FUTURES_TRADING_INTERVAL_SECONDS", 300)
OPTION_CHAIN_REFRESH_INTERVAL_SECONDS = get_int_config("OPTION_CHAIN_REFRESH_INTERVAL_SECONDS", 300)
SMC_REFRESH_INTERVAL_SECONDS = get_int_config("SMC_REFRESH_INTERVAL_SECONDS", 900)
VOLUME_PROFILE_REFRESH_INTERVAL_SECONDS = get_int_config("VOLUME_PROFILE_REFRESH_INTERVAL_SECONDS", 900)
